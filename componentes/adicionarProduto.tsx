...
const AdicionarProduto: React.FC = () => {
  ...
  return (
    <div>
        ...
        {produtos.map((produto) => (
          <div key={produto.id} className="produto ">
            <div className="d-flex d-flex-column gap-2 align-items-center">
              ...
              <span className="totalProduto">Total: {produto.total}</span>
            </div>
          </div>
        ))}
      </div>
      ...
      <Modal className="bg-light-silver" show={showModal} onHide={handleClose}>
        ...
        <Modal.Body className="bg-dark ">
          ...
          {/* Repita o mesmo padrão para outros campos do novo produto */}

          <Button variant="primary" className="btn btn-primary mt-3 mx-1" onClick={adicionarProduto}>
            Adicionar
          </Button>
          <Button variant="secondary" className="btn btn-primary mt-3 mx-1" onClick={handleClose}>
            Fechar
          </Button>
        </Modal.Body>
      </Modal>
